...
$factory->define(OiBRControleBoleto::class, function (Faker $faker) {
    ...
    $operation = \TradeAppOne\Domain\Enumerators\Operations::OI_CONTROLE_BOLETO;
    return [
        'sector'      => $sector,
        'operator'    => $operator,
        'operation'   => $operation,
...
$factory->state(OiBRControleBoleto::class, 'migration', function (Faker $faker) {
    $faker->addProvider(new pt_BR\Person($faker));
