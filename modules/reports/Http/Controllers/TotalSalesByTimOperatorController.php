...
class TotalSalesByTimOperatorController extends Controller
{
    ...
    {
        try {
            return $this->filterSalesByOperatorService->getFilterSalesByOperator(Operations::TIM, request()->all());
