...
class FujiokaReportCommand extends Command
{
    protected $signature   = 'hourly:fujioka {--date= : Date of sync, example 2018-12-12-10-10}  {--exclude=*}';
    ...
    public function handle()
    {
        ...
        $allOptions = array_merge($this->options(), [
            'network' => NetworkEnum::FUJIOKA,
            'chatId'  => 'telegram.fujioka',
        ]);
