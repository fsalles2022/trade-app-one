...
class VivoControle extends Service
{
    public const INVOICE_TYPES = [VivoInvoiceType::EMAIL, VivoInvoiceType::VIA_POSTAL, VivoInvoiceType::DEBITO_AUTOMATICO];
    ...
    public function rules(): array
    {
        return [
            ...
            'bankId' => 'required_if:invoiceType, DEBITO_AUTOMATICO|numeric|between:1,20',
