...
namespace Buyback\Resources\contracts\Vouchers\Watch;
...
class VoucherWatchLayout extends VoucherBase
{
    ...
    public function toHtml(): string
    {
        ...
        return view('voucher-watch', ['sale' => $this])->render();
    }
    ...
    private function getTradeInService($sale): ?Service
    {
        ...
        return $services->filter(static function (Service $service) {
            return $service->operator === Operations::TRADE_IN_MOBILE &&
                $service->operation === Operations::WATCH && $service->sector === Operations::TRADE_IN;
        })->first();
    }
