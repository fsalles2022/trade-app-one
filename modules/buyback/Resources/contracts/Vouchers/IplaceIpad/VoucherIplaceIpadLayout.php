...
namespace Buyback\Resources\contracts\Vouchers\IplaceIpad;
...
class VoucherIplaceIpadLayout extends VoucherBase
{
    ...
    public function toHtml(): string
    {
        ...
        return view('voucher-iplace-ipad', ['sale' => $this])->render();
    }
    private function getTradeInService($sale): ?Service
    {
        ...
        return $services->filter(static function (Service $service) {
            return $service->operator === Operations::TRADE_IN_MOBILE &&
                $service->operation === Operations::IPLACE_IPAD && $service->sector === Operations::TRADE_IN;
        })->first();
    }
