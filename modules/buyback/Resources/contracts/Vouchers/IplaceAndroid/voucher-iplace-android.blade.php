...
<body lang=PT-BR>
<div class="voucher">
    <p class="text-title" align=center><b>PROGRAMA TRADE IN (IPLACE ANDROID)</b></p>
    ...
    <table class="voucher-table" border=1 cellspacing=0 cellpadding=0>
        ...
        <tr>
            <td rowspan=2><b>EQUIPAMENTO</b></td>
        ...
        <tr>
            <td><b>VALOR OFERTA</b></td>
            <td>R$ {{ $sale->price }},00</td>
        </tr>
        @if(data_get($sale, 'evaluationsBonusString') !== null)
        <tr>
            <td><b>DETALHAMENTO DO INCREMENTO</b></td>
            <td>{{ $sale->evaluationsBonusString }}</td>
        </tr>
        @endif
        <tr>
            <td><b>NÚMERO DO VOUCHER</b></td>
        ...
        <tr>
            <td colspan="2"  style="border-bottom-width: 0px; text-align: justify ">
                <p>O CEDENTE, acima qualificado, cede e transfere neste ato, de forma irrevogável e irretratável, a
                    ...
                    inscrita no CNPJ/MF sob o nº 22.696.923/0001-62, aqui denominada “TRADE UP GROUP” e/ou a quem esta indicar, pelo Valor da Oferta
        ...
        <tr>
            <td colspan="2" style="border-top: 0; border-bottom: 0; text-align: center;">
