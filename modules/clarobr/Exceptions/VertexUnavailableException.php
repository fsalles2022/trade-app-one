...
class VertexUnavailableException extends ThirdPartyExceptions
{
    ...
    {
        return trans('exceptions.third_party_unavailable', ['service' => 'Vertex']);
    }
    ...
    {
        Log::debug('third-party-api-vertex', ['url' => 'offline']);
    }
}
